...
namespace awsiotsdk {
    namespace samples {
        ResponseCode PubSub::RunPublish(int msg_count) {
			...
			util::String p_topic_name_str = "demo_topic";//SDK_SAMPLE_TOPIC;
        ...
        ResponseCode PubSub::Subscribe(util::String topic_name) {
            //util::String p_topic_name_str = SDK_SAMPLE_TOPIC;
            std::unique_ptr<Utf8String> p_topic_name = Utf8String::Create(/*p_*/topic_name/*_str*/);
        ...
        ResponseCode PubSub::Unsubscribe(util::String topic_name) {
            //util::String p_topic_name_str = SDK_SAMPLE_TOPIC;
            std::unique_ptr<Utf8String> p_topic_name = Utf8String::Create(/*p_*/topic_name/*_str*/);
        ...
        ResponseCode PubSub::InitializeTLS() {
            ...
            if (ResponseCode::SUCCESS != rc) {
				std::cout << "TCP Conection failed " << std::endl;
...
int main(int argc, char **argv) {
	...
	awsiotsdk::ResponseCode rc = awsiotsdk::ConfigCommon::InitializeCommon("SampleConfig.json");

	//    awsiotsdk::ResponseCode rc = awsiotsdk::ConfigCommon::InitializeCommon("..\\..\\aws-iot-device-sdk-cpp\\common\\SampleConfig.json");
